...
The rust-analyzer binary is now available as rustup component for all Tier1 and several Tier2 targets for nightly builds and can be installed using
...
Alternatively you can download the pre-built binary from the https://github.com/rust-analyzer/rust-analyzer/releases[releases] page.
...
You can also install it from source using the following command:
